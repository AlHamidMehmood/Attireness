  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-brand-white">
      ...
      <motion.div 
        ...
        className="absolute -top-20 -left-20 w-96 h-96 bg-brand-accent rounded-full blur-[120px] -z-10"
      />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative z-10">
            ...
            >
              <span className="inline-block text-brand-accent font-semibold tracking-[0.3em] uppercase text-xs mb-4">
                New Collection 2026
              </span>
              <h1 className="text-6xl md:text-8xl font-serif font-bold leading-[0.9] mb-8 tracking-tighter">
                Elevate Your <br />
                <span className="italic text-brand-accent">Everyday</span> Style
              </h1>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="absolute -top-6 -right-6 w-32 h-32 bg-brand-accent/20 -z-10" />
            </motion.div>
          </div>
        </div>
      </div>
